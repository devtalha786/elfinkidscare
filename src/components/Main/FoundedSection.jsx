      ...
      >
        ...
        >
          <p className="text-base text-white md:text-[1.528vw] leading-[20px] md:leading-[2.222vw] text-center">
            {
              "Founded with a passion for making every child's haircut a joyful adventure, "
            }
            <Link
              href="#"
            ...
            <strong>™</strong>
            {
              " opened its doors in March 2024. Our team is dedicated to creating an environment where kids not only get a great haircut but also experience moments of delight and excitement. "
            }
            {"That's why we created ELFIN KIDS CARE"}
            <strong>™</strong>
            {
              " so that parents and kids can have the same magical hair moments at home with our line of kid-friendly hair care products made with all organic, food-based ingredients."
            }
          </p>
